        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden md:block ml-12">
                <div className="flex items-baseline space-x-8">
                  <a
                    ...
                    className="text-[var(--foreground)] hover:text-[var(--primary-dark)] font-medium px-3 py-2 rounded-lg hover:rgba(201,168,124,0.1) transition"
                  >
                     数据面板
                  </a>
                  <a
                  ...
                  <a
                    href="/"
                    className="text-[var(--foreground-muted)] hover:text-[var(--foreground)] text-sm font-medium px-3 py-2 rounded-lg hover:bg-[var(--background-secondary)] transition"
                  >
                    返回主站
                  </a>
                </div>
            ...
            <div className="flex items-center">
              <button
                onClick={() => router.push('/')}
                className="ml-4 px-4 py-2 text-sm font-medium text-[var(--foreground)] bg-white border rgba(201,168,124,0.3) rounded-lg hover:bg-[var(--background-card)] transition"
              >
                退出商家后台
              </button>
            </div>
