    ...
    <div className="min-h-screen" style={{background:'#faf8f5'}}>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {msg && (
          ...
          <div className={`mb-6 p-4 rounded-xl text-sm ${msg.includes('失败') || msg.includes('错误') ? 'rgba(177,93,94,0.08) var(--rose) border border-red-200' : 'rgba(74,117,86,0.08) var(--sage) border border-green-200'}`}>
                    ...
                    <div className="p-5">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            {svc.featured && (
                              ...
                              <span className="px-2 py-0.5 rounded-full text-sm font-bold var(--sage)" style={{background:'#ecfdf5',border:'1px solid #a7f3d0'}}>人气王</span>
                      ...
                      <div className="flex gap-2">
                        ...
                        <button onClick={() => handleDelete(svc.id)}
                          ...
                          className="px-3 py-2 rounded-lg text-sm font-bold border transition hover:rgba(177,93,94,0.08) hover:border-red-300 hover:var(--rose)" style={{border:'1.5px solid rgba(201,168,124,0.2)',color:'var(--foreground-muted)'}}>
