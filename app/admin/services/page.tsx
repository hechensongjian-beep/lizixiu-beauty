    ...
    <div className="min-h-screen" style={{background:'#faf8f5'}}>
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        {msg && (
          ...
          <div className={`mb-6 p-4 rounded-xl text-sm ${msg.includes('失败') || msg.includes('错误') ? 'bg-red-50 var(--rose) border border-red-200' : 'bg-green-50 var(--sage) border border-green-200'}`}>
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex gap-2">
                        ...
                        <button onClick={() => handleDelete(svc.id)}
                          ...
                          className="px-3 py-2 rounded-lg text-sm font-bold border transition hover:bg-red-50 hover:border-red-300 hover:var(--rose)" style={{border:'1.5px solid #e8e4df',color:'#6b6b68'}}>
