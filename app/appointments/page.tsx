...
export default async function AppointmentsPage() {
  ...
  if (loading) return (
    <div className="max-w-4xl mx-auto px-4 py-12"><div className="h-10 w-48 rounded-lg animate-pulse var(--background-secondary) mb-8"></div><div className="space-y-4"><div className="bg-white rounded-xl p-5 animate-pulse"><div className="flex gap-4"><div className="w-16 h-16 rounded-xl var(--background-secondary)"></div><div className="flex-1 space-y-2"><div className="h-5 var(--background-secondary) rounded w-1/3"></div><div className="h-4 var(--background-secondary) rounded w-1/2"></div><div className="h-4 var(--background-secondary) rounded w-1/4"></div></div></div></div><div className="bg-white rounded-xl p-5 animate-pulse"><div className="flex gap-4"><div className="w-16 h-16 rounded-xl var(--background-secondary)"></div><div className="flex-1 space-y-2"><div className="h-5 var(--background-secondary) rounded w-1/3"></div><div className="h-4 var(--background-secondary) rounded w-1/2"></div><div className="h-4 var(--background-secondary) rounded w-1/4"></div></div></div></div></div></div>
  );
