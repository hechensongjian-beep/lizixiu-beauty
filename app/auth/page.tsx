  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      <div className="text-center mb-12">
        ...
        <h1 className="text-2xl font-bold var(--foreground) mb-4">欢迎来到丽姿秀</h1>
        <p className="var(--foreground-muted) text-lg max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="bg-white border rgba(201,168,124,0.2) rounded-2xl p-8 hover:shadow-lg transition">
          ...
          <h2 className="text-2xl font-bold var(--foreground) mb-4">我是客户</h2>
          ...
          <div className="space-y-4">
            ...
            <Link
              href="/auth/register"
              className="block px-6 py-3 border rgba(201,168,124,0.3) var(--foreground) font-semibold rounded-lg hover:var(--background-card) transition text-center"
            >
              注册客户账号
            </Link>
          </div>
        ...
        <div className="bg-white border rgba(201,168,124,0.2) rounded-2xl p-8 hover:shadow-lg transition">
          <div className="text-2xl mb-6"></div>
          <h2 className="text-2xl font-bold var(--foreground) mb-4">我是商家</h2>
          <p className="var(--foreground) mb-6">
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-2xl p-8">
        <h3 className="text-xl font-semibold var(--foreground) mb-4"> 不知道如何选择？</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center">
            <div className="text-2xl mb-2 font-bold text-[#c9a87c]">免费</div>
            <div className="font-medium var(--foreground)">完全免费</div>
            <p className="text-sm var(--foreground-muted)">注册、使用、基础功能全部免费</p>
          </div>
          <div className="text-center">
            <div className="text-2xl mb-2"></div>
            <div className="font-medium var(--foreground)">快速启动</div>
            <p className="text-sm var(--foreground-muted)">1分钟注册，立即开始使用</p>
          </div>
          <div className="text-center">
            <div className="text-2xl mb-2"></div>
            <div className="font-medium var(--foreground)">多端适配</div>
            <p className="text-sm var(--foreground-muted)">电脑、手机、平板都能流畅使用</p>
          </div>
        </div>
      </div>
    </div>
