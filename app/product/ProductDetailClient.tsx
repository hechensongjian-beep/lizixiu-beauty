              ...
              {services.map(svc => (
                <Link key={svc.id} href={`/appointments?service=${svc.id}`}
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full flex items-center justify-center text-white font-medium" style={{ background: 'var(--accent)', border: '1px solid var(--primary-light)', fontSize: '0.75rem' }}>
                      {svc.name?.charAt(0) || 'S'}
                    </div>
                    <div>
