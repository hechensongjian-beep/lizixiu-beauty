    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-10">
        <div className="text-center mb-10">
          <div className="h-8 w-40 bg-gray-100 rounded-lg mx-auto mb-3 animate-pulse" style={{ maxWidth: '200px' }}></div>
          <div className="h-4 w-56 bg-gray-50 rounded mx-auto animate-pulse" style={{ maxWidth: '280px' }}></div>
        </div>
